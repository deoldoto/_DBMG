object frmConsultaPedido: TfrmConsultaPedido
  ...
  object cdsResultadoPesquisa: TClientDataSet
    ...
    object cdsResultadoPesquisacliente: TStringField
      FieldName = 'cliente'
      Size = 50
    end
    object cdsResultadoPesquisahora: TDateTimeField
      FieldName = 'hora'
    end
    object cdsResultadoPesquisavalor_total: TFloatField
      FieldName = 'valor_total'
    end
    ...
    object cdsResultadoPesquisaidCliente: TIntegerField
      FieldName = 'idCliente'
    end
  end
